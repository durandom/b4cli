...
from b4cli.settings import APIConfig, LoggingConfig, Settings
...
class TestLoggingConfig:
    ...
    def test_default_logging_config(self):
        ...
        # In pytest mode, file is automatically set to logs/test-b4cli.log
        if config.pytest_mode:
            assert str(config.file) == "logs/test-b4cli.log"
        else:
